...
class Bip39
{
    ...
    public static function validateMnemonic(string $mnemonic): bool
    {
        ...
        foreach ($words as $word) {
            if (!in_array($word, self::getBip39WordList())) {
                return false;
            }
        }
    ...
    public static function mnemonicToSeed(string $mnemonic, string $passphrase = ''): string
    {
        ...
        return hash_pbkdf2('sha512', $mnemonic, $salt, $iterations, $keyLength, true);
    }
    ...
    public static function generateMnemonic(int $wordCount = 12): string
    {
        ...
        for ($i = 0; $i < $wordCount; $i++) {
            $words[] = $wordList[random_int(0, 2047)];
        }
     ...
     * 获取BIP39完整词库（2048个单词）
     */
    public static function getBip39WordList(): array
    {
        return [
            ...
            'episode', 'equal', 'equip', 'era', 'erase', 'erode', 'erosion', 'error', 'escape', 'essay',
            ...
            'loan', 'lobby', 'local', 'lock', 'logic', 'lonely', 'long', 'loop', 'lottery', 'loud',
            ...
            'plastic', 'plate', 'play', 'pleasure', 'pledge', 'pluck', 'plug', 'plunge', 'poem', 'poet',
            ...
            'ring', 'riot', 'rip', 'ritual', 'rival', 'river', 'road', 'roast', 'robot', 'robust',
            ...
            'sunset', 'super', 'supply', 'support', 'sure', 'surface', 'surge', 'surprise', 'surround', 'survey',
            ...
            'wasp', 'waste', 'water', 'wave', 'way', 'wealth', 'weapon', 'weary', 'weather', 'web',
